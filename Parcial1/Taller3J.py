'''dibujar el plano cartesiano capturar 2 puntos, dibujar un truangulo entre los dos puntos y el centro
cada vez que se pulse la tecla espacio, mover el pto mas a la derecha 20 pixeles y redibujar el
triangulo'''
